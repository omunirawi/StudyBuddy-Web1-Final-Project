// =========================================================
// app.js
// Goal: connect everything together (events + SPA navigation + startup).
// - sets up click events
// - handles routing (show/hide sections)
// - loads resources.json using fetch()
// =========================================================
...
// ---------- NAV / SPA ROUTING ----------
// We show one section at a time. No page reload.
...
// ---------- RESOURCES ----------
// Resources: load the JSON file, then render the list
